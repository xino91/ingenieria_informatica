...
*/
	...
	std::cout.width(5);  std::cout << std::left << this->getCodigoPostal();
	std::cout  << "\t"; 
	std::cout.width(35);  std::cout << std::left << this->getNombre();
	std::cout  << "\t"; 
	std::cout.width(6);  std::cout << std::internal << this->getHombres();
	std::cout  << "\t"; 
	std::cout.width(6);  std::cout << std::internal << this->getMujeres();
	std::cout << "\t"; 
	std::cout.width(6);  std::cout << std::internal << this->getHabitantes() << std::endl;
}
