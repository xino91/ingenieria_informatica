;EJERCICIOS DE CLASE
;SUMAR LOS ELEMENTOS DE UN  VECTOR (REPRESENTADO A TRAVÉS DE UN HECHO ORDENADO)
...
; La tarea de la suma se realiza mediante una regla que incluye un patrón con comodines multicampo
; y una variable. Esto hará que cada vez que se aplique la regla se utilizará un valor del vector
; (representado mediante un hecho ordenado).
...
(defrule sumar  
 ...
 =>
   ...
   (printout t "Suma parcial: " ?*s* crlf)
)
...
;***************************************************************
;Otra forma de hacerlo. Observar lo que ocurre al poner o quitar las líneas comentadas.
;Justificar lo sucede.
;***************************************************************
;HECHOS INICIALES
(deffacts vectores
  (v 1 2 3 4 5)
