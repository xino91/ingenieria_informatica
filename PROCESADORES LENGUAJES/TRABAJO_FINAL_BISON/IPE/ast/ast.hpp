...
{
 private: 	
   std::string _cadena; //!< \brief number of the NumberNode
...
*/
  CadenaNode(std::string value)
	...
	/*!	
	\brief   Get the type of the expression: CADENA
	\return  int
	\sa		 print
	*/
	int getType();
...
/*!	
  ...
  \note    PlusNode Class publicly inherits from CadenaOperatorNode class 
		   and adds its own print and evaluate functions
*/
class ConcatNode : public CadenaOperatorNode {
  public:
/*!		
	\brief Constructor of ConcatNode uses CadenaperatorNode's constructor as members initializer
	\param L: pointer to ExpNode
	\param R: pointer to ExpNode
	\post  A new ConcatNode is created with the parameter
*/
  ConcatNode(ExpNode *L, ExpNode *R) : CadenaOperatorNode(L,R) 
  {
		// Empty
  }
...
/*!	
	\brief   Evaluate DivisionEnteraNode
	\return  double
	\sa		 print
*/
  double evaluateNumber();
...
/*!	
  \class   read_stringStmt
  \brief   Definition of atributes and methods of read_stringStmt class
  \note    ReadStmt Class publicly inherits from Statement class 
		   and adds its own print and evaluate functions
*/
class read_stringStmt : public Statement 
{
  private:
	std::string _id; //!< Name of the ReadStmt
  ...
  public:
/*!		
	\brief Constructor of read_stringStmt
	\param id: string, name of the variable of the read_stringStmt
	\post  A new read_stringStmt is created with the parameter
*/
  read_stringStmt(std::string id)
	{
		this->_id = id;
	}

/*!
	\brief   Print the read_stringStmt
	\return  void
	\sa		 evaluate()
*/
  void print();
...
/*!	
	\brief   Evaluate the read_stringStmt
	\return  void
	\sa		 print
*/
  void evaluate();
...
/*!	
  \class   print_stringStmt
  \brief   Definition of atributes and methods of print_stringStmt class
  \note    print_stringStmt Class publicly inherits from Statement class 
		   and adds its own print and evaluate functions
  \warning  In this class, print and evaluate functions have the same meaning.
*/
class print_stringStmt: public Statement 
{
 private:
  ExpNode *_exp; //!< Expresssion the print statement
 ...
 public:
/*!		
	\brief Constructor of print_stringStmt 
	\param expression: pointer to ExpNode
	\post  A new print_stringStmt is created with the parameter
*/
  print_stringStmt(ExpNode *expression)
	{
		this->_exp = expression;
	}

/*!
	\brief   Print the print_stringStmt
	\return  void
	\sa		 evaluate()
*/
  void print();
...
/*!	
	\brief   Evaluate the print_stringStmt
	\return  double
	\sa		 print
*/
  void evaluate();
...
class IfStmt : public Statement 
{
 private:
  ...
  std::list<lp::Statement *> *_list1; //!< list of Statement of the consequent
  std::list<lp::Statement *> *_list2; //!< list of Statement of the alternative
...
/*!		
	...
	\param statement1: list of Statement of the consequent
	\post  A new IfStmt is created with the parameters
*/
  IfStmt(ExpNode *condition, std::list<lp::Statement *> *statement1)
	{
		this->_cond = condition;
		this->_list1 = statement1;
		this->_list2 = NULL;
	}
...
/*!		
	...
	\param condition: ExpNode of the condition
	\param statement1: list Statement of the consequent
	\param statement2: list Statement of the alternative
	\post  A new IfStmt is created with the parameters
*/
  IfStmt(ExpNode *condition, std::list<lp::Statement *> *statement1, std::list<lp::Statement *> *statement2)
	{
		this->_cond = condition;
		this->_list1 = statement1;
		this->_list2 = statement2;
	}
...
class WhileStmt : public Statement 
{
 private:
  ...
  std::list<lp::Statement *> *_list1; //!< list of Statement of the body of the while loop

  public:
/*!		
	\brief Constructor of  WhileStmt
	\param condition: ExpNode of the condition
	\param statement: list of Statement of the body of the loop 
	\post  A new WhileStmt is created with the parameters
*/
  WhileStmt(ExpNode *condition,std::list<lp::Statement *> *statement)
	{
		this->_cond = condition;
		this->_list1 = statement;
	}
...
*/
 RepeatStmt(ExpNode *condition,std::list<lp::Statement *> *statement)
	{
		this->_cond = condition;
		this->_list1 = statement;
	}
...
{
  private:
  std::string _id; //!< Name of Variable
  ExpNode *_from;//!< Condicion of the forstatement
  ExpNode *_to;//!< Condicion of the forstatement
  ExpNode *_step;//!< Action of the forstatement
...
/*!		
	...
	\param from: ExpNode of the condition
	\param to: ExpNode of the condition
	\param step: ExpNode of the condition
	\param statement: list of Statement of the body of the loop 
...
class LugarStmt : public Statement {
	private:
		ExpNode * _exp1;//!< Position x in the screen
		ExpNode * _exp2;//!< Position y in the screen
	public:
		/*!		
	\brief Constructor of  LugarStmt
	\param exp1: ExpNode of de position
	\param exp2: ExpNode of de position
	\post  A new LugarStmt is created with the parameters
*/
		LugarStmt(ExpNode *exp1, ExpNode *exp2){_exp1=exp1;_exp2=exp2;};
/*!	
	\brief   Print of LugarStmt
	\return  void
	\sa		 evaluate
*/		
void print();
/*!	
	\brief   Evaluate of BorrarStmt
	\return  void
	\sa		 print
*/
void evaluate();
