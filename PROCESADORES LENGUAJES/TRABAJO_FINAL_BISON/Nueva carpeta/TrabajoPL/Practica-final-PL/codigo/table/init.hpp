...
static struct {
	      ...
	      int token;
	                    ...
	                    "escribir", PRINT,
						"escribir_cadena", PRINT_STRING, //Nuevo en el trabajo
	                    "leer",  READ, 
						"leer_cadena", READ_STRING,	 //Nuevo en el trabajo	
						"si",	 IF,   		// NEW in example 17
						"si_no",	 ELSE, 		// NEW in example 17
						"mientras",  WHILE,	// NEW in example 17
						"fin_si", IF_END,
						"fin_mientras", WHILE_END, //Nuevo en el trabajo
						"hacer", DO, //Nuevo en el trabajo
						"entonces", THEN, //Nuevo en el trabajo
						"repetir", REPEAT, //Nuevo en el trabajo
						"hasta", UNTIL, //Nuevo en 
						"para", FOR, //Nuevo en el trabajo
						"desde", FROM, //Nuevo en el trabajo
						"fin_para", FOR_END, //Nuevo en el trabajo
						"paso", PASO, //Nuevo en el trabajo			
	                    "",      0
	                   };
